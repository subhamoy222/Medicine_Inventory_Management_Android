...
type Props = NativeStackScreenProps<RootStackParamList, "PurchaseBill">;
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: "#f8f9fa", padding: 15 }}>
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 15 }}>
        ...
        <TouchableOpacity style={[styles.button, { backgroundColor: "#28a745" }]} onPress={submitPurchaseBill}>
          <Text style={styles.buttonText}>Create Purchase Bill</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
